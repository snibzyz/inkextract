...
class RegexPatterns:
    ...
    def _load_patterns(self):
        ...
        # ตัดเฉพาะ "ตัววงเล็บ/ตัวคั่น CJK" ที่หลุดมา — ห้ามกลืนเนื้อหาข้างในวงเล็บ
        # (บั๊กเดิม: 【.*?】 / （.*?） กลืนทั้งก้อนก่อนตรวจ ทำให้โน้ตจีนของผู้แต่งที่ครอบวงเล็บหลุดตรวจ foreign ทั้งบรรทัด)
        base_patterns = [
            r'[【】・（）「」『』]',
        ]
