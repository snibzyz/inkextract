    ...
    def clean_final_files(self):
        ...
        try:
            ...
            for file_path in txt_files:
                ...
                # ตรวจตามแท็กอย่างเดียว ทุกบรรทัด — เจอ [A] ลบทิ้ง / เจอ [B] ตัดแท็กเก็บเนื้อหา
                # ไม่มีเคสพิเศษ "เก็บบรรทัดแรกตามเดิม" แล้ว เพราะชื่อตอนภาษาจีน ([A]) เคยหลุดเข้า Clean ทุกตอน
                # หัวตอนที่ไม่มีแท็กยังถูกเก็บไว้ผ่านสาขา else ด้านล่าง
